...
if [[ $OSTYPE == 'darwin'* ]]; then
  cp node_modules/electron-holochain/binaries/lair-keystore electron/bin/lair-keystore
  ...
  cp node_modules/electron-holochain/binaries/lair-keystore.exe electron/bin/lair-keystore.exe
