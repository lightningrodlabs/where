...
import { Coord, PlaysetEntry } from "../types";
...
export class WherePlaysetDialog extends ScopedElementsMixin(LitElement) {
  ...
  render() {
    return html`
<mwc-dialog id="playset-inner-dialog" heading="New Playset" @opened=${
  ...
  <mwc-textarea type="text" @input=${() =>
    (
      this.shadowRoot!.getElementById("description-field") as TextArea
    ).reportValidity()}
