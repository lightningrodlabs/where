...
export class WhereCloneLudoDialog extends ScopedElementsMixin(LitElement) {
  ...
  render() {
    ...
    return html`
      ...
      <mwc-dialog id="enter-code-dialog" heading="${msg('Add Library: Enter code')}" @opened=${this.handleDialogOpened}>
      ...
      <mwc-dialog id="set-name-dialog" heading="${msg('Add Library: Choose name')}" @opened=${this.handleDialogOpened}>
      ...
      <mwc-dialog id="create-new-dialog" heading="${msg('Add Library: Create new')}" @opened=${this.handleDialogOpened}>
